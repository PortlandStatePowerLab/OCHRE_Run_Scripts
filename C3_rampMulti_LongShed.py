...
# -*- coding: utf-8 -*-
"""
HPWH Simulation with Only Morning Load-Up and Morning Shed (6 AM to Midnight)
"""
...
filename = '180217_2_15_RCJ_LongMorningShed'  # updated filename label
...
# Base schedule template (no evening)
my_schedule = {
    'M_LU_time': '03:00',
    'M_LU_duration': 3,
    'M_S_time': '06:00',
    'M_S_duration': 18  # shed from 6 AM to midnight
}

# Randomization bins for morning load-up
...
def determine_hpwh_control(sim_time, current_temp_c, sched_cfg, **kwargs):
    ...
    # Morning shed: 6 AM to midnight
    elif pd.Timestamp(f"{base_date} 06:00") <= sim_time < pd.Timestamp(f"{base_date + pd.Timedelta(days=1)} 00:00"):
        ctrl_signal['Water Heating'].update({
...
if __name__ == "__main__":
    ...
    for home in homes:
        ...
        # Morning shed always starts at 6 AM and runs to midnight
        sched['M_S_time'] = '06:00'
        sched['M_S_duration'] = 18  # hours

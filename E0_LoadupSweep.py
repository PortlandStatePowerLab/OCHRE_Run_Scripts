...
filename = '180110_1_3_Load_Bounce' # date that's thrown away, num of simulation days, data res, ramp or no ramp control
# 04 / 07 
...
Tcontrol_SHEDF = 130 
step = 1
Tcontrol_dbF = np.arange(1, 5 + step, step)  # Deadband sweep list (°F)

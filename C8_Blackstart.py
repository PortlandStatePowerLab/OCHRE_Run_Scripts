...
filename = '180110_1_3_Reserve3' # date that's thrown away, num of simulation days, data res, ramp or no ramp control
# 04 / 07 
...
Tcontrol_SHEDF = 65
step = 10
Tcontrol_dbF = np.arange(10, 10 + step, step)  # Deadband sweep list (°F)
...
# Randomization bins
M_LU_weights = [8, 19, 25, 30, 33, 36, 38, 41, 42, 44, 46, 47] #[14, 28, 34, 41, 46, 46, 41, 33, 30, 31, 35, 30]
M_LU_bins = pd.date_range("06:00", periods=len(M_LU_weights), freq="90min").strftime("%H:%M").tolist()

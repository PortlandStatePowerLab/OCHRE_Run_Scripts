...
filename = '180110_1_3_Reserve' # date that's thrown away, num of simulation days, data res, ramp or no ramp control
# 04 / 07 
...
# Randomization bins
M_LU_weights = [11, 12, 11, 12, 13, 15, 18, 16, 16, 15, 15, 17, 16, 17, 16, 17, 17, 15, 15, 15, 14, 13, 14, 14, 15, 14, 13, 13] #[14, 28, 34, 41, 46, 46, 41, 33, 30, 31, 35, 30]
M_LU_bins = pd.date_range("12:00", periods=len(M_LU_weights), freq="15min").strftime("%H:%M").tolist()
...
if __name__ == "__main__":
    ...
    for home in homes:
        ...
        min_end = pd.to_datetime("19:30", format=fmt)  # minimum end at 6 AM

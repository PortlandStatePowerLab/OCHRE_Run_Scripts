...
filename = '180111_3min_randomLU_'
...
# Base schedule (M_LU_time will be replaced per home)
my_schedule = {
    'M_LU_time': '03:00',
    'M_LU_duration': 3,
    'M_S_time': '06:00',
...
if __name__ == "__main__":
    ...
    # Create weighted pool of M_LU start times
    ...
    # Assign randomized schedules to homes
    home_schedules = {}
    for home in homes:
        if available_starts:
        ...
        # Compute duration until M_S_time
        fmt = "%H:%M"
        ...
        sched['M_LU_duration'] = duration_hours
